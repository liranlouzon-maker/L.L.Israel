...
const TRANSLATIONS = {
  en: {
    ...
    service1_name: 'Security Services & Consulting',
    service1_desc: 'Our security and consulting services include close protection, risk assessment, security surveys, loss prevention, investigations and surveillance, CCTV systems, anti-drone technologies, and advanced detection solutions. Each service is tailored to the client\'s specific requirements, operational environment, and risk profile.',
    ...
    service2_tag6: 'Restaurant & Hotel Reservations',
    service3_name: 'Transportation',
    service3_desc: 'Private chauffeur and limousine services, secure airport transfers, executive ground transportation, chauffeur staffing, security drivers, armored transfers upon request, and full travel coordination.',
